...
# Alpine:
#
#   apk add --no-cache git make && git clone https://github.com/nholuongut/diagrams-as-code diagrams && cd diagrams && make
#
# Debian / Ubuntu:
#
#   apt-get update && apt-get install -y make git && git clone https://github.com/nholuongut/diagrams-as-code diagrams && cd diagrams && make
#
# RHEL / CentOS:
#
#   yum install -y make git && git clone https://github.com/nholuongut/diagrams-as-code diagrams && cd diagrams && make
